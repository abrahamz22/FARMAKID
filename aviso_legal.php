...
<body>
    ...
    <div class="container-aviso">
        ...
        <h1 class="title-aviso">AVISO LEGAL Y CONDICIONES
            GENERALES DE USO</h1>

        <h2 class="title-aviso">Informacion general</h2> 
        ...
        <p class="parrafo-aviso">
            ...
            La titularidad de este sitio web, www.pharmakid.com, (en adelante, Sitio Web) la ostenta: Abraham, con
            NIF: 39245618V, y cuyos datos de contacto son:
        ...
        <h2 class="title-aviso">II. TÉRMINOS Y CONDICIONES GENERALES DE USO</h2>

        <h3 class="title-aviso">El objeto de las condiciones: El Sitio Web</h3>
        ...
        <p class="parrafo-aviso">
            ...
            Página para los padres de infantes se reserva la facultad de modificar, en cualquier momento, y sin aviso
            previo, la presentación y configuración del Sitio Web y de los Contenidos y Servicios que en él pudieran
            estar incorporados. El Usuario reconoce y acepta que en cualquier momento Página para los padres de
            infantes pueda interrumpir, desactivar y/o cancelar cualquiera de estos elementos que se integran en el
        ...
        <h3 class="title-aviso">El Usuario</h3>

        <p class="parrafo-aviso">
            El acceso, la navegación y uso del Sitio Web, así como por los espacios habilitados para interactuar entre
            los Usuarios, y el Usuario y Página para los padres de infantes, como los comentarios y/o espacios de
            ...
            El Sitio Web de Página para los padres de infantes proporciona gran diversidad de información, servicios y
            datos. El Usuario asume su responsabilidad para realizar un uso correcto del Sitio Web. Esta
            responsabilidad se extenderá a:
            Un uso de la información, Contenidos y/o Servicios y datos ofrecidos por Página para los padres de
            infantes sin que sea contrario a lo dispuesto por las presentes Condiciones, la Ley, la moral o el
            orden público, o que de cualquier otro modo puedan suponer lesión de los derechos de terceros o
            del mismo funcionamiento del Sitio Web.
            La veracidad y licitud de las informaciones aportadas por el Usuario en los formularios extendidos
            por Página para los padres de infantes para el acceso a ciertos Contenidos o Servicios ofrecidos por
            el Sitio Web. En todo caso, el Usuario notificará de forma inmediata a Página para los padres de
            infantes acerca de cualquier hecho que permita el uso indebido de la información registrada en
            dichos formularios, tales como, pero no solo, el robo, extravío, o el acceso no autorizado a
            identificadores y/o contraseñas, con el fin de proceder a su inmediata cancelación.
            Página para los padres de infantes se reserva el derecho de retirar todos aquellos comentarios y
            ...
            En cualquier caso, Página para los padres de infantes no será responsable de las opiniones vertidas por los
            ...
            Página para los padres de infantes y el Usuario.
            El Usuario declara ser mayor de edad y disponer de la capacidad jurídica suficiente para vincularse por las
            presentes Condiciones. Por lo tanto, este Sitio Web de Página para los padres de infantes no se dirige a
            menores de edad. Página para los padres de infantes declina cualquier responsabilidad por el
            incumplimiento de este requisito.
            El Sitio Web está dirigido principalmente a Usuarios residentes en España. Página para los padres de
            infantes no asegura que el Sitio Web cumpla con legislaciones de otros países, ya sea total o parcialmente.
            Si el Usuario reside o tiene su domiciliado en otro lugar y decide acceder y/o navegar en el Sitio Web lo
            hará bajo su propia responsabilidad, deberá asegurarse de que tal acceso y navegación cumple con la
            legislación local que le es aplicable, no asumiendo Página para los padres de infantes responsabilidad
            alguna que se pueda derivar de dicho acceso.

        </p>

        <h2 class="title-aviso">III. ACCESO Y NAVEGACIÓN EN EL SITIO WEB:
            EXCLUSIÓN DE GARANTÍAS Y RESPONSABILIDAD</h2>

            <p class="parrafo-aviso">Página para los padres de infantes no garantiza la continuidad, disponibilidad y utilidad del Sitio Web, ni de
                los Contenidos o Servicios. Página para los padres de infantes hará todo lo posible por el buen
                ...
                Usuario. En ningún caso Página para los padres de infantes será responsable por las pérdidas, daños o
                perjuicios de cualquier tipo que surjan por el acceso, navegación y el uso del Sitio Web, incluyéndose, pero
                no limitándose, a los ocasionados a los sistemas informáticos o los provocados por la introducción de virus.
                Página para los padres de infantes tampoco se hace responsable de los daños que pudiesen ocasionarse a
                los usuarios por un uso inadecuado de este Sitio Web. En particular, no se hace responsable en modo
                alguno de las caídas, interrupciones, falta o defecto de las telecomunicaciones que pudieran ocurrir.</p>

        <h2 class="title-aviso">IV. POLÍTICA DE ENLACES</h2>

        <p class="parrafo-aviso">
            Se informa que el Sitio Web de Página para los padres de infantes pone o puede poner a disposición de los
            ...
            Página para los padres de infantes no ofrece ni comercializa por sí ni por medio de terceros los productos
            ...
            Página para los padres de infantes en ningún caso revisará o controlará el contenido de otros sitios web,
            así como tampoco aprueba, examina ni hace propios los productos y servicios, contenidos, archivos y
            cualquier otro material existente en los referidos sitios enlazados.
            Página para los padres de infantes no asume ninguna responsabilidad por los daños y perjuicios que
            pudieran producirse por el acceso, uso, calidad o licitud de los contenidos, comunicaciones, opiniones,
            productos y servicios de los sitios web no gestionados por Página para los padres de infantes y que sean
            enlazados en este Sitio Web.
            El Usuario o tercero que realice un hipervínculo desde una página web de otro, distinto, sitio web al Sitio
            Web de Página para los padres de infantes deberá saber que:
            No se permite la reproducción —total o parcialmente— de ninguno de los Contenidos y/o Servicios del Sitio
            Web sin autorización expresa de Página para los padres de infantes.
            No se permite tampoco ninguna manifestación falsa, inexacta o incorrecta sobre el Sitio Web de Página
            para los padres de infantes, ni sobre los Contenidos y/o Servicios del mismo.
            ...
            salvo autorización expresa de Página para los padres de infantes.
            El establecimiento del hipervínculo no implicará la existencia de relaciones entre Página para los padres de
            infantes y el titular del sitio web desde el cual se realice, ni el conocimiento y aceptación de Página para
            los padres de infantes de los contenidos, servicios y/o actividades ofrecidas en dicho sitio web, y
            viceversa.
        </p>

        <h2 class="title-aviso">V. PROPIEDAD INTELECTUAL E INDUSTRIAL</h2>

        <p class="parrafo-aviso">Página para los padres de infantes por sí o como parte cesionaria, es titular de todos los derechos de
            ...
            comerciales, en cualquier soporte y por cualquier medio técnico, sin la autorización de Página para los
            padres de infantes.
            El Usuario se compromete a respetar los derechos de propiedad intelectual e industrial de Página para los
            padres de infantes. Podrá visualizar los elementos del Sitio Web o incluso imprimirlos, copiarlos y
            ...
            Página para los padres de infantes a través de los datos de contacto del apartado de INFORMACIÓN
            GENERAL de este Aviso Legal y Condiciones Generales de Uso.</p>


            <h2 class="title-aviso">VI. ACCIONES LEGALES, LEGISLACIÓN APLICABLE Y
                JURISDICCIÓN
                </h2>

        <p class="parrafo-aviso">
            Página para los padres de infantes se reserva la facultad de presentar las acciones civiles o penales que
considere necesarias por la utilización indebida del Sitio Web y Contenidos, o por el incumplimiento de las
presentes Condiciones.
La relación entre el Usuario y Página para los padres de infantes se regirá por la normativa vigente y de
...
generador de plantilla de aviso legal y condiciones de uso online el día 21/11/2023.
        </p>
