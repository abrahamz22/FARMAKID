...
<body>
    ...
    <div class="container-aviso">
        ...
        <h1 class="title-aviso">POLÍTICA DE PRIVACIDAD DEL
            SITIO WEB
            </h1>

            <link href="www.pharmakid.com">

        <h3 class="title-aviso">I. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS
        </h3> 

        <p class="parrafo-aviso">
            Respetando lo establecido en la legislación vigente, Programa Infantil (en adelante, también Sitio Web) se
        ...
        <h3 class="title-aviso">Leyes que incorpora esta política de privacidad
        </h3>
        ...
        <h3 class="title-aviso">Identidad del responsable del tratamiento de los datos personales
        </h3>

        <p class="parrafo-aviso">
            El responsable del tratamiento de los datos personales recogidos en Programa Infantil es: Abraham
            Zambrano, Ernesto Díaz Jiménez, con NIF: 39857491V (en adelante, Responsable del tratamiento). Sus
        ...
        <h3 class="title-aviso">Registro de Datos de Carácter Personal
        </h3>

            <p class="parrafo-aviso">
                En cumplimiento de lo establecido en el RGPD y la LOPD-GDD, le informamos que los datos personales
                recabados por Programa Infantil, mediante los formularios extendidos en sus páginas quedarán
                incorporados y serán tratados en nuestro fichero con el fin de poder facilitar, agilizar y cumplir los
                compromisos establecidos entre Programa Infantil y el Usuario o el mantenimiento de la relación que se
        ...
        <h3 class="title-aviso">Principios aplicables al tratamiento de los datos personales
        </h3>
        ...
        <h3 class="title-aviso">Categorías de datos personales
        </h3>

        <p class="parrafo-aviso">Las categorías de datos que se tratan en Programa Infantil son únicamente datos identificativos. En ningún
            caso, se tratan categorías especiales de datos personales en el sentido del artículo 9 del RGPD.</p>
        ...
        <h3 class="title-aviso">Base legal para el tratamiento de los datos personales</h3>

        <p class="parrafo-aviso">
            La base legal para el tratamiento de los datos personales es el consentimiento. Programa Infantil se
        ...
        <h3 class="title-aviso">Fines del tratamiento a que se destinan los datos personales
        </h3>

        <p class="parrafo-aviso">
            Los datos personales son recabados y gestionados por Programa Infantil con la finalidad de poder facilitar,
            ...
            estadística, y actividades propias del objeto social de Programa Infantil, así como para la extracción,
        ...
        <h3 class="title-aviso">Destinatarios de los datos personales
        </h3>

        <p class="parrafo-aviso">
            Los datos personales del Usuario serán compartidos con los siguientes destinatarios o categorías de
            destinatarios:
            PHARMAKID, S.L con domicilio en la Av. Diagonal
            HOSTINGWEB S,A con domicilio Carrer de l\\\'Artesania, 55, 08042 Barcelona
        ...
        <h3 class="title-aviso">Datos personales de menores de edad
        </h3>
        ...
        <p class="parrafo-aviso">
            ...
            podrán otorgar su consentimiento para el tratamiento de sus datos personales de forma lícita por
            Programa Infantil. Si se trata de un menor de 14 años, será necesario el consentimiento de los padres o
            tutores para el tratamiento, y este solo se considerará lícito en la medida en la que los mismos lo hayan
            autorizado.
        </p>

        <h3 class="title-aviso">Secreto y seguridad de los datos personales
        </h3>


        <p class="parrafo-aviso">
            Programa Infantil se compromete a adoptar las medidas técnicas y organizativas necesarias, según el nivel
            ...
            Sin embargo, debido a que Programa Infantil no puede garantizar la inexpugnabilidad de internet ni la
        ...
        <h3 class="title-aviso">Derechos derivados del tratamiento de los datos personales
        </h3>


        <p class="parrafo-aviso">
            El Usuario tiene sobre Programa Infantil y podrá, por tanto, ejercer frente al Responsable del tratamiento
            los siguientes derechos reconocidos en el RGPD y la Ley Orgánica 3/2018, de 5 de diciembre, de
            Protección de Datos Personales y garantía de los derechos digitales:
            Derecho de acceso: Es el derecho del Usuario a obtener confirmación de si Programa Infantil está
            tratando o no sus datos personales y, en caso afirmativo, obtener información sobre sus datos
            concretos de carácter personal y del tratamiento que Programa Infantil haya realizado o realice, así
            como, entre otra, de la información disponible sobre el origen de dichos datos y los destinatarios de
            ...
            de carácter personal o se cese el tratamiento de los mismos por parte de Programa Infantil.
            ...
            del tratamiento con la referencia \"RGPD-www.pharmakid.com\", especificando:
            ...
            cualquier otro medio válido en derecho que acredite la identidad.
            ...
            Dirección postal: Carrer de l\\\'Artesania, 55, 08042 Barcelona
            Correo electrónico: pharmakid2003@gmail.com

        </p>


        <h3 class="title-aviso">Enlaces a sitios web de terceros
        ...
        <p class="parrafo-aviso">
            ...
            distintos de Programa Infantil, y que por tanto no son operados por Programa Infantil. Los titulares de
            dichos sitios web dispondrán de sus propias políticas de protección de datos, siendo ellos mismos, en cada
            caso, responsables de sus propios ficheros y de sus propias prácticas de privacidad.
        </p>

        <h3 class="title-aviso">Reclamaciones ante la autoridad de control
        </h3>
        ...
        <p class="parrafo-aviso">
            ...
            Programa Infantil se reserva el derecho a modificar su Política de Privacidad, de acuerdo a su propio
            ...
            de política de privacidad web gratis online el día 23/11/2023.
        </p>
