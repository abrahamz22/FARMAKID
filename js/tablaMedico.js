window.addEventListener('load', function() {
     ...
     document.getElementById("anadirButton").addEventListener("click", function() {
        ...
        botonesEliminar.forEach(function(elemento) {
            elemento.addEventListener("click", function() {
                ...
                document.getElementById("tablaModificar").style.display="none";
                document.getElementById("infoBlockEliminar").innerHTML="Seguro que deseas eliminar al especialista con la id " + textoCeldaIzquierda;
    ...
    botonesModificar.forEach(function(boton) {
        boton.addEventListener('click', function() {
            ...
            document.getElementById("especialidadMod").value = valores[2];
            document.getElementById("numColegiadoMod").value = valores[3];
            document.getElementById("emailMod").value = valores[4];
            document.getElementById("telefonoMod").value = valores[5];
            document.getElementById("idMod").value = valores[6];
