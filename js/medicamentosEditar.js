...
window.addEventListener('load', function() {
    ...
    if(usuario == "admin"){ 
            ...
            for(let i = 0; i < document.getElementsByClassName("edit-fot-med").length; i++){
                document.getElementsByClassName("edit-fot-med")[i].style.display = "block";
            } 
        } 
    if(usuario == "usuario"){ 
        for(let i = 0; i < document.getElementsByClassName("edit").length; i++){
        ...
        for(let i = 0; i < document.getElementsByClassName("edit-fot-med").length; i++){
            document.getElementsByClassName("edit-fot-med")[i].style.display = "none";
        } 
